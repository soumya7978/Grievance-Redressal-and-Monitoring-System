...
public class ModifyStaff extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			PreparedStatement ps=con.prepareStatement("select *from pstaff where ID=?");
			...
			out.println("<form action='ModifyStaff2' method='get'>");
			...
			out.println("<option value='CARPENTER'>CARPENTER</option>");
			out.println("<option value='ELECTRICIAN'>ELECTRICIAN</option>");
			out.println("<option value='JANITOR'>JANITOR</option>");
			out.println("<option value='MASON'>MASON</option>");
			out.println("<option value='PAINTER'>PAINTER</option>");
			out.println("<option value='PLUMBER'>PLUMBER</option>");
			out.println("<option value='SECURITY'>SECURITY</option>");
			out.println("<option value='WARDBOY'>WARDBOY</option>");
