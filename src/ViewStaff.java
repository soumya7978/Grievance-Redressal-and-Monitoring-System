...
public class ViewStaff extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			PreparedStatement ps=con.prepareStatement("select *from pstaff");
...
//			ps.setString(1,roll);
			...
			out.println(" <html><center><table border=2 width=50% height=20%");
...
//			out.println("</form");
			...
			System.out.println("error in ViewStaff");
